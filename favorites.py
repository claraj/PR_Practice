...
favorite_book = 'The Dragon Reborn by Robert Jordon'
print(f'One of ITEC 2905s favorite books is {favorite_book}')

## Favorite Animal

favorite_animal = 'cat'
print(f'One of ITEC 2905s favorite colors is {favorite_animal}')
